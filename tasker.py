...
# ToDo: Рефакторинг: убрать импортирование *; для каждого виджета использовать super() в __init__;
# убрать __init__ везде, где он не нужен.
# ToDo: Добавить скролл в текстовые окошки.
